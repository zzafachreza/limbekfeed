    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => navigation.navigate('BMI')} style={{
                    flexDirection: 'row',
                    padding: 20,

                    marginVertical: 2
                }}>
                    <Icon type='ionicon' name='calculator-outline' size={20} />
                    <Text style={{
                        left: 5,
                        flex: 1,
                        fontFamily: fonts.primary[600],
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Tentang', {
                    ...
                    <Icon type='ionicon' name='information-circle-outline' size={20} />
                    <Text style={{
                        left: 5,
                        flex: 1,
                        fontFamily: fonts.primary[600],
