    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <MyInput label="Tinggi Badan" iconname="body" value={kirim.tinggi_badan} onChangeText={x => setKirim({ ...kirim, tinggi_badan: x })} />

                <MyGap jarak={10} />
                <MyInput label="Berat Badan" iconname="speedometer" value={kirim.berat_badan} onChangeText={x => setKirim({ ...kirim, berat_badan: x })} />
                <MyGap jarak={10} />

                <MyPicker label="Jenis Kelamin" onValueChange={x => setKirim({
                    ...kirim,
                    jenis_kelamin: x
                })} value={kirim.jenis_kelamin} data={[
                ...
                <MyPicker label="Umur" onValueChange={x => setKirim({
                    ...kirim,
                    umur: x
                })} value={kirim.umur} data={[
                    { label: '18-29 Tahun', value: '18-29 Tahun' },
                    { label: '30-39 Tahun', value: '30-39 Tahun' },
                    { label: '40-50 Tahun', value: '40-50 Tahun' },
                ]} iconname="male-female" />
                <MyGap jarak={10} />
                <MyPicker label="Goals" onValueChange={x => setKirim({
                    ...kirim,
                    goals: x
                })} value={kirim.goals} data={[
